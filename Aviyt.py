...
def option():
    ...
    clear()
    stderr.writelines(f"""
  __  ____      ____  ____   __    ___  __ _  ____  ____ 
 (  )(  _ \ ___(_  _)(  _ \ / _\  / __)(  / )(  __)(  _ \
  )(  ) __/(___) )(   )   //    \( (__  )  (  ) _)  )   /
 (__)(__)       (__) (__\_)\_/\_/ \___)(__\_)(____)(__\_)
 
              {Wh}[ + ]  C O D E   B Y  AVI YT  [ + ]
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}AVIYT - TRACKER - IP ADDRESS {Wh}|
       : o    `.        {Wh}|       {Gr}@CODE BY AVIYT      {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
